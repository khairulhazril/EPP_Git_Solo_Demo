...
void sendCommand(char command)
{
	...
	switch(command)
	{
		...
		case 'q':
			commandPacket.params[0] = 10;//preset degrees 
			commandPacket.params[1] = 65;//preset power
			commandPacket.command = COMMAND_TURN_LEFT;
			sendPacket(&commandPacket);
			break;
        ...
        case 'm':
        case 'M':
            commandPacket.command = COMMAND_ADJUST;
            sendPacket(&commandPacket);
            break;

        case 'y':
        case 'Y':
            commandPacket.command = COMMAND_STORE;
            sendPacket(&commandPacket);
            break;
        ...
        case 'U':
            getParams(&commandPacket);
            commandPacket.command = COMMAND_STORE_LEFT;
            sendPacket(&commandPacket);
            break;
        ...
        case 'I':
            getParams(&commandPacket);
            commandPacket.command = COMMAND_STORE_RIGHT;
            sendPacket(&commandPacket);
            break;

        case 'o':
        case 'O':
           commandPacket.command = COMMAND_COPY_STACK;
           sendPacket(&commandPacket);
           break;

        case 'p':
        case 'P':
            commandPacket.command = COMMAND_POP_STACK;
            sendPacket(&commandPacket);
            break;
